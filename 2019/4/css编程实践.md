...
2. 记住对于编程语言来说，有一个重要原则是 Try Don't Repeat Yourself，但是对于 css 来说，这一原则并不适用。更适合 css 的方式是 Keep It Simple, Stupid。如果你要为了复用一两块 css 代码而损失减少代码的可读性和复杂度，那是万万不可的，所以，保持简单就好。
